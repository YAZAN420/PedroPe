...
class garbage:
    ...
    def open_pipe1(cls):
        ...
        wait(200)
        left_motor.run_angle(speed=500, rotation_angle=23)
        left_motor.hold()
    ...
    def open_pipe2(cls):
        ...
        base.syncAcc(-250)
        down_motor.run_angle(speed=1000, rotation_angle=150, wait=False)
        downClaw()
        base.syncAcc(760, acc=900)
