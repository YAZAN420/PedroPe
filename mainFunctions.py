...
def move_to_the_other_side():
    ...
    # downClaw()
    # wait(1000)
    # base.move_sideway(100, -50, 0)
    # wait(1000)
    # base.stop()
    # right_motor.run_time(speed=600,time=300)
    # wait(1000)
    # base.syncAcc(40)
    # wait(1000)
    # moveUntilBlock(300)
    # wait(1000)
    base.syncAcc(600)
    garbage.move_until_white(left_sensor)
    up_motor.run_time(speed=1000, time=300)
    reset()
    left_motor.run_angle(speed=-400, rotation_angle=50)
    # wait(1000)
    downClaw()
    # wait(1000)
    down_motor.run_time(speed=-10000, time=600)
    down_motor.run_time(speed=10000, time=600)
    # wait(1000)
    upClaw()
    left_motor.run_angle(speed=400, rotation_angle=50)
    ...
    down_motor.run_time(speed=10000, time=600)
    upClaw()
    down_motor.run_time(speed=1000,time=500)
    # left_motor.run_angle(speed=400, rotation_angle=50)
    base.move_mm(70,500)
    base.turn(90)
    downClaw()
...
def take4block(tmp=150):
    base.move_mm(tmp, 150)
